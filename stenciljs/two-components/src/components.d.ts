...
export namespace Components {
  ...
  interface SecondComponentAttributes extends StencilHTMLAttributes {
    /**
    * The first name
    */
    'first'?: string;
...
declare global {
  interface StencilElementInterfaces {
    ...
    'SecondComponent': Components.SecondComponent;
  }

  interface StencilIntrinsicElements {
    'my-component': Components.MyComponentAttributes;
    'second-component': Components.SecondComponentAttributes;
  }
